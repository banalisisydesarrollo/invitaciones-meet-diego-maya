...
export default async function handler(req) {
  ...
  const membrete =
    `${host}/assets/membrete-diego-maya.jpg`;
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: '14px',
            background:
              'linear-gradient(135deg, #0d2e62, #164d9c)',
            alignItems: 'center',
        ...
        >
          ...
          >
            Haz clic para ingresar a la reunión
          </div>
